...
{
    // C:/Program Files (x86)/Windows Kits/10/Include/10.0.18362.0/um/objidlbase.h:6288
    public class IPipeLong : IUnknown // 1
    {
        static Guid s_uuid = new Guid("db2f3acc-2f86-11d1-8e04-00c04fb9989a");
        public static new ref Guid IID => ref s_uuid;
        public override ref Guid GetIID() { return ref s_uuid; }

        public int Pull(ref int buf, uint cRequest, IntPtr pcReturned)
        {
            if(m_PullFunc==null){
        ...
        public int Push(ref int buf, uint cSent)
        {
            if(m_PushFunc==null){
