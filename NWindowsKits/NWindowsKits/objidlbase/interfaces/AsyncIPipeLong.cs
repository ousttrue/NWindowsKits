...
{
    // C:/Program Files (x86)/Windows Kits/10/Include/10.0.18362.0/um/objidlbase.h:6384
    public class AsyncIPipeLong : IUnknown // 1
    {
        static Guid s_uuid = new Guid("db2f3acd-2f86-11d1-8e04-00c04fb9989a");
        ...
        public int Finish_Pull(ref int buf, IntPtr pcReturned)
        {
        ...
        delegate int Finish_PullFunc(IntPtr self, ref int buf, IntPtr pcReturned);
        Finish_PullFunc m_Finish_PullFunc;

        public int Begin_Push(ref int buf, uint cSent)
        {
        ...
        delegate int Begin_PushFunc(IntPtr self, ref int buf, uint cSent);
