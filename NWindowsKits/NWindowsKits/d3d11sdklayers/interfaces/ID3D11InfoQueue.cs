...
{
    // C:/Program Files (x86)/Windows Kits/10/Include/10.0.18362.0/um/d3d11sdklayers.h:2151
    public class ID3D11InfoQueue : IUnknown // 1
    {
        static Guid s_uuid = new Guid("6543dbb6-1b48-42f5-ab82-e97ec74326f6");
        ...
        public int GetMessageA(ulong MessageIndex, ref D3D11_MESSAGE pMessage, IntPtr pMessageByteLength)
        {
        ...
        public int AddStorageFilterEntries(ref D3D11_INFO_QUEUE_FILTER pFilter)
        {
        ...
        public int GetStorageFilter(ref D3D11_INFO_QUEUE_FILTER pFilter, IntPtr pFilterByteLength)
        {
        ...
        public int PushStorageFilter(ref D3D11_INFO_QUEUE_FILTER pFilter)
        {
        ...
        public int AddRetrievalFilterEntries(ref D3D11_INFO_QUEUE_FILTER pFilter)
        {
        ...
        public int GetRetrievalFilter(ref D3D11_INFO_QUEUE_FILTER pFilter, IntPtr pFilterByteLength)
        {
        ...
        public int PushRetrievalFilter(ref D3D11_INFO_QUEUE_FILTER pFilter)
        {
