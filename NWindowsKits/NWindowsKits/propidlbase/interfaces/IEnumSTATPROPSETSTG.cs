...
{
    // C:/Program Files (x86)/Windows Kits/10/Include/10.0.18362.0/um/propidlbase.h:963
    public class IEnumSTATPROPSETSTG : IUnknown // 2
    {
        static Guid s_uuid = new Guid("0000013b-0000-0000-c000-000000000046");
        ...
        delegate int NextFunc(IntPtr self, uint celt, ref STATPROPSETSTG rgelt, IntPtr pceltFetched);
        NextFunc m_NextFunc;
