...
{
    // C:/Program Files (x86)/Windows Kits/10/Include/10.0.18362.0/um/OAIdl.h:2376
    public class IEnumVARIANT : IUnknown // 2
    {
        static Guid s_uuid = new Guid("00020404-0000-0000-c000-000000000046");
        public static new ref Guid IID => ref s_uuid;
        public override ref Guid GetIID() { return ref s_uuid; }

        public int Next(uint celt, ref VARIANT rgVar, IntPtr pCeltFetched)
        {
            if(m_NextFunc==null){
            ...
            return  m_NextFunc(m_ptr, celt, ref rgVar, pCeltFetched);
        }
        delegate int NextFunc(IntPtr self, uint celt, ref VARIANT rgVar, IntPtr pCeltFetched);
        NextFunc m_NextFunc;
