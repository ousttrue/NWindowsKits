...
{
    // C:/Program Files (x86)/Windows Kits/10/Include/10.0.18362.0/um/ObjIdl.h:9838
    public class IEnumSTATSTG : IUnknown // 2
    {
        static Guid s_uuid = new Guid("0000000d-0000-0000-c000-000000000046");
        public static new ref Guid IID => ref s_uuid;
        public override ref Guid GetIID() { return ref s_uuid; }

        public int Next(uint celt, ref STATSTG rgelt, IntPtr pceltFetched)
        {
            if(m_NextFunc==null){
        ...
        delegate int NextFunc(IntPtr self, uint celt, ref STATSTG rgelt, IntPtr pceltFetched);
        NextFunc m_NextFunc;
