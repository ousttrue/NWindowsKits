...
{
    // C:/Program Files (x86)/Windows Kits/10/Include/10.0.18362.0/um/ObjIdl.h:8708
    public class IEnumMoniker : IUnknown // 2
    {
        static Guid s_uuid = new Guid("00000102-0000-0000-c000-000000000046");
