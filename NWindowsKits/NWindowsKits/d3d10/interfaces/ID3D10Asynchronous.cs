...
{
    // C:/Program Files (x86)/Windows Kits/10/Include/10.0.18362.0/um/d3d10.h:4092
    public class ID3D10Asynchronous : ID3D10DeviceChild // 1
    {
        ...
        public int GetData(IntPtr pData, uint DataSize, uint GetDataFlags)
        {
