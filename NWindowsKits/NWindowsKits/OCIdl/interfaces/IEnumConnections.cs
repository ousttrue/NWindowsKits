...
{
    // C:/Program Files (x86)/Windows Kits/10/Include/10.0.18362.0/um/OCIdl.h:476
    public class IEnumConnections : IUnknown // 2
    {
        static Guid s_uuid = new Guid("b196b287-bab4-101a-b69c-00aa00341d07");
